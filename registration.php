    ...
    <div class="regs"
      <form>
          ...
          <div class="mb-3">
              ...
              <input type="text" pattern="" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              <div id="emailHelp" class="form-text"></div>
          </div>
          <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Резус-фактор</label>
          ...
          <div class="mb-3">
              ...
              <input type="password" pattern="(?=.*\d)(?=.*\s)(?=.*\W)(?=.*[a-z])(?=.*[A-Z]).{12,}" class="form-control" id="exampleInputPassword1">
          </div>
