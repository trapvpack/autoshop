...
<main>
            ...
            <form class="card newcard" method="post" action="/autoshop/edit.php">
                <p>ФИО</p>
                <input value="<?= htmlspecialchars($current['username']) ?>" type="text" name="username"
                <p>Стоимость сделки</p>
                <input value="<?= htmlspecialchars($current['cost']) ?>" type="number" name="cost">
                <p>Модель</p>
                <input value="<?= htmlspecialchars($current['carname']) ?>" type="text" name="carname">
                <p>Отзыв</p>
                <textarea  name="review"><?= htmlspecialchars($current['review']) ?></textarea>

                <button type="submit" class="btn btn-success">Изменить сделку
                </button>
