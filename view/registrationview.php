...
<html lang="en">
  ...
  <main>
      ...
      <form class="regs" action="/autoshop/registration.php" method="post">
          <div class="mb-3">
          ...
          <div class="mb-3">
              ...
              <input name="bloodGroup" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              <div id="emailHelp" class="form-text"></div>
          </div>
          <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Резус-фактор</label>
              <input name="resusFactor" type="text"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              <div id="emailHelp" class="form-text"></div>
          </div>
          <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Дата рождения</label>
              <input name="date_of_birthday" type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              <div id="emailHelp" class="form-text"></div>
          </div>
          <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Пароль</label>
              <input name="password" type="password" pattern="(?=.*\d)(?=.*\W)(?=.*[a-z])(?=.*[A-Z]).{12,}" class="form-control" id="exampleInputPassword1">
          </div>
